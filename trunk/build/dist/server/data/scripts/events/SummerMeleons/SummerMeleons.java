...
public class SummerMeleons extends Functions implements ScriptFile, OnDeathListener, OnPlayerEnterListener
{
	...
	private static File multiSellFile = new File(Config.DATAPACK_ROOT, "scripts/events/SummerMeleons/3790004.xml");
	...
	{
		if(_active && SimpleCheckDrop(cha, killer) && Rnd.chance(Config.EVENT_THE_FALL_HARVEST_POLLEN_DROP_CHANCE * killer.getPlayer().getRateItems() * ((NpcInstance) cha).getTemplate().rateHp))
		{
