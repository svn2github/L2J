...
import l2next.gameserver.model.entity.events.impl.ClanHallMiniGameEvent;
import l2next.gameserver.model.entity.events.impl.SiegeEvent;
import l2next.gameserver.model.entity.events.objects.CMGSiegeClanObject;
...
public class RainbowYetiInstance extends NpcInstance
{
	 ...
	 *
	 */
	private static final long serialVersionUID = -8337090577606356062L;
	...
	private class GenerateTask extends RunnableImpl
	{
		...
		public void runImpl() throws Exception
		{
			...
			GArray<Player> around = World.getAroundPlayers(RainbowYetiInstance.this, 750, 100);
	...
	public void onSpawn()
	{
		...
		GArray<Player> around = World.getAroundPlayers(this, 750, 100);
		for(Player player : around)
		{
