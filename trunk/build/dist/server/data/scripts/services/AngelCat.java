...
public class AngelCat extends Functions implements ScriptFile
{
	...
	private static final Location[] SPAWN_LOC = {
		new Location(-114190, 254114, -1528, 27931),
		// Talkin
		new Location(16121, 142931, -2696, 27931),
		// Dion
		new Location(83680, 147996, -3400, 64087),
		// Giran
		new Location(111299, 219409, -3544, 61496),
		// Heine
		new Location(-14068, 123822, -3120, 27433),
		// Gludio
		new Location(-80999, 149996, -3040, 59718),
		// Gludin
		new Location(82921, 53097, -1488, 61318),
		// Oren
		new Location(147457, -55382, -2728, 40707),
		// Goddard
		new Location(86898, -142831, -1336, 41834),
		// Shuttgard
		new Location(43918, -47713, -792, 30607),
		// Rune
		new Location(147251, 25628, -2008, 28713),
		// Aden
		new Location(117281, 76733, -2688, 30749),
		// Hunters
	};
