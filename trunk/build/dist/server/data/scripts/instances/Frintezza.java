...
public class Frintezza extends Reflection
{
	...
	private class Music extends RunnableImpl
	{
		 ...
		 */
		private GArray<Creature> getSongTargets(int songId)
		{
	...
	{
		private final GArray<Creature> _targets;
		 ...
		 */
		public SongEffectLaunched(GArray<Creature> targets, int song, int currentTimeOfSong)
		{
			_targets = targets;
			_song = song;
