 ...
 * TODO.
 */
public class OrbisTempleStage6 extends DynamicQuest implements ScriptFile
{
	private static final Logger _log = LoggerFactory.getLogger(OrbisTempleStage6.class);
	...
	private static final String START_TIME1 = "55 2 * * *";
	private static final String START_TIME2 = "25 6 * * *";
	private static final String START_TIME3 = "55 9 * * *";
	private static final String START_TIME4 = "25 13 * * *";
	private static final String START_TIME5 = "55 16 * * *";
	private static final String START_TIME6 = "25 20 * * *";
	...
	private static final int KILL_OTOH_MOB = 206; // Клиентский параметр
