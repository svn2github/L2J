 ...
 * TODO.
 */
public class OrbisTempleStage2 extends DynamicQuest implements ScriptFile
{
	private static final Logger _log = LoggerFactory.getLogger(OrbisTempleStage2.class);
	...
	private static final String START_TIME1 = "35 00 * * *";
	private static final String START_TIME2 = "05 4 * * *";
	private static final String START_TIME3 = "35 7 * * *";
	private static final String START_TIME4 = "05 11 * * *";
	private static final String START_TIME5 = "35 14 * * *";
	private static final String START_TIME6 = "05 18 * * *";
	private static final String START_TIME7 = "35 21 * * *";
	...
	private static final int KILL_OTOH_MOB = 202; // Клиентский параметр
	private static final int MAX_TASK_POINT = 60000;
