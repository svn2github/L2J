 ...
 * TODO.
 */
public class OrbisTempleStage3 extends DynamicQuest implements ScriptFile
{
	private static final Logger _log = LoggerFactory.getLogger(OrbisTempleStage3.class);
	...
	private static final int DURATION = 30; //WTF?!

	private static final String START_TIME1 = "10 1 * * *";
	private static final String START_TIME2 = "40 4 * * *";
	private static final String START_TIME3 = "10 8 * * *";
	private static final String START_TIME4 = "40 11 * * *";
	private static final String START_TIME5 = "10 15 * * *";
	private static final String START_TIME6 = "40 18 * * *";
	private static final String START_TIME7 = "10 22 * * *";
	...
	private static final int KILL_OTOH_MOB = 203; // Клиентский параметр
	private static final int MAX_TASK_POINT = 90000;
	...
	private final class KillListenerImpl implements OnKillListener
	{
		...
		public void onKill(Creature actor, Creature victim)
		{
			...
			if(victim.isNpc() && isStarted() && ArrayUtils.contains(LOH_MOBS, victim.getNpcId()))
			{
				...
				{
					case ORBIS1:
						increaseTaskPoint(KILL_OTOH_MOB, actor.getPlayer(), 1); //(unk,Кому, сколько)
						break;
					case ORBIS2:
