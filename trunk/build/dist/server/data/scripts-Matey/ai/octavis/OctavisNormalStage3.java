...
/**
 * @author KilRoy
 * Октавис - 3я стадия (АИ)
 * Примитивен, агрится, выдаёт мостХейт на гвардов, атакует скилами по откату
 * TODO[K]: Скилы пока от фреи
 */
public class OctavisNormalStage3 extends Fighter
{
	...
	private static final int Skill_IceStorm = 6283; // Ледяной шторм по площади 1200 радиуса (По видео у ОКТАВИСА есть данный скил)
