...
import l2next.gameserver.network.serverpackets.ExMailArrived;
...
public class ClanCommunity extends Functions implements ScriptFile, ICommunityBoardHandler
{
	...
	public void onBypassCommand(Player player, String bypass)
	{
		...
		else if("clbbslist".equals(cmd))
		{
			...
			HashMap<Integer, String> tpls = Util.parseTemplate(HtmCache.getInstance().getNotNull("bbs_clanlist.htm", player));
			...
			String tpl = HtmCache.getInstance().getNotNull("bbs_clantpl.htm", player);
		...
		else if("clbbsclan".equals(cmd))
		{
			...
			HashMap<Integer, String> tpls = Util.parseTemplate(HtmCache.getInstance().getNotNull("bbs_clan.htm", player));
			String html = tpls.get(0);
		...
		else if("clbbsadmi".equals(cmd))
		{
			...
			String html = HtmCache.getInstance().getNotNull("bbs_clanadmin.htm", player);
		...
		else if("mailwritepledgeform".equals(cmd))
		{
			...
			String html = HtmCache.getInstance().getNotNull("bbs_pledge_mail_write.htm", player);
		...
		else if("announcepledgewriteform".equals(cmd))
		{
			...
			HashMap<Integer, String> tpls = Util.parseTemplate(HtmCache.getInstance().getNotNull("bbs_clanannounce.htm", player));
			String html = tpls.get(0);
	...
	private class Listener implements OnPlayerEnterListener
	{
		...
		public void onPlayerEnter(Player player)
		{
			...
			{
				String html = HtmCache.getInstance().getNotNull("clan_popup.htm", player);
				html = html.replace("%pledge_name%", clan.getName());
