...
public class TrulyFree extends SimpleItemHandler
{
	...
	protected boolean useItemImpl(Player player, ItemInstance item, boolean ctrl)
	{
		...
		switch(itemId)
		{
			case 18549: /* Наградной Сундук Экспедиционного Отряда */
				use18549(player, ctrl);
				break;
			case 32263: /* Сундук Переродившегося Героя Олимпиады */
				use32263(player, ctrl);
				break;
			case 34760: /* Упаковка: Сертификат Подопечного */
				use34760(player, ctrl);
				break;
			case 35548: /* Припасы Инженеров Софа */
				use35548(player, ctrl);
				break;
			//case 35700: /* Золотая Коробка с Подарками Снегурочки Ивент */
			//use35700(player, ctrl);
			//break;
			//case 35701: /* Красный Носок Снегурочки Ивент */
			//use35701(player, ctrl);
			//break;
			//case 35704: /* Мешок Кристаллов Экспедиционного Отряда */
			//use35704(player, ctrl);
			//break;
			case 35709: /* Припасы Софа */
				use35709(player, ctrl);
				break;
			case 35720: /* Коробка с Шапкой Снегурочки 1 день (ивент) */
				use35720(player, ctrl);
				break;
			case 35721: /* Коробка с Шапкой Снегурочки 3 дня (ивент) */
				use35721(player, ctrl);
				break;
			case 35745: /* Коробка с Шапкой Драко (ивент) */
				use35745(player, ctrl);
				break;
			case 35751: /* Коробка Сверкающих Аксессуаров Драко Ивент */
