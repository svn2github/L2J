 ...
 * Массив элементов обнуляется, если количество элементов в нем равно <tt>0</tt>.
 * При получении элементов с помощью метода {@link List#get(int) List.get(int)}, как и при итерации, может вернуть null, в случае, если индекс выходит за пределы массива.
 * <p>
