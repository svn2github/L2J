package l2next.commons.executor;

import l2next.commons.threading.PriorityThreadFactory;
...
public class ParallelExecutor
{
	...
	public void execute(Object obj, Class<?> clazz, String methodName, Object... args) throws SecurityException, NoSuchMethodException
	{
		execute(TaskCreator.createTask(obj, clazz, methodName, args));
	}

	public void execute(Object obj, String className, String methodName, Object... args) throws SecurityException, NoSuchMethodException, ClassNotFoundException
	{
	...
	public void execute(Class<?> clazz, String methodName, Object... args) throws SecurityException, NoSuchMethodException
	{
		execute(TaskCreator.createTask(clazz, methodName, args));
	}

	public void execute(String className, String methodName, Object... args) throws SecurityException, NoSuchMethodException, ClassNotFoundException
	{
