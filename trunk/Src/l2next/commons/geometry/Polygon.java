package l2next.commons.geometry;
...
public class Polygon extends AbstractShape
{
	...
	public boolean validate()
	{
		...
		// внешний цикл - перебираем все грани многоугольника
		{
			...
			{
				int ii = i + 1 < points.length ? i + 1 : 0; // вторая точка
				// первой линии
				// внутренний цикл - перебираем все грани многоугольниках кроме
				// той, что во внешнем цикле и соседних
				for(int n = i; n < points.length; n++)
				{
					if(Math.abs(n - i) > 1)
					{
						int nn = n + 1 < points.length ? n + 1 : 0; // вторая
						// точка
						// второй
						// линии
