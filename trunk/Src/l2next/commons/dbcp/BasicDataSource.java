...
public class BasicDataSource implements DataSource
{
	 ...
	 * @param idleTimeOut
	 *            The minimum amount of time connection may stay in pool (in seconds)
	 * @param idleTestPeriod
	 *            The period of time to check idle connections (in seconds)
	...
	public BasicDataSource(String driver, String connectURI, String uname, String passwd, int maxActive, int maxIdle, int idleTimeOut, int idleTestPeriod, boolean poolPreparedStatements)
	{
		...
		@SuppressWarnings("unused") PoolableConnectionFactory poolableConnectionFactory = new PoolableConnectionFactory(connectionFactory, connectionPool, statementPoolFactory, "SELECT 1", false, true);
