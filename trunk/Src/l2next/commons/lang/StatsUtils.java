...
public final class StatsUtils
{
	...
	{
		double maxMem = memMXbean.getHeapMemoryUsage().getMax() / 1024.; // maxMemory
		// is
		// the
		// upper
		// limit
		...
		// can
		// use
		double allocatedMem = memMXbean.getHeapMemoryUsage().getCommitted() / 1024.; // totalMemory
		// the
		// size
		// of
		// the
		...
		// allocation
		// pool
		double usedMem = memMXbean.getHeapMemoryUsage().getUsed() / 1024.; // freeMemory
		// the
		// unused
		// memory
		// in
		...
		// allocation
		// pool
		double nonAllocatedMem = maxMem - allocatedMem; // non allocated memory
		// till jvm limit
		double cachedMem = allocatedMem - usedMem; // really used memory
		double useableMem = maxMem - usedMem; // allocated, but non-used and
