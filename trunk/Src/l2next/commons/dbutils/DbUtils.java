package l2next.commons.dbutils;
...
public class DbUtils
{
	...
	/**
	 * Close a <code>Connection</code>, <code>Statement</code> and <code>ResultSet</code>. Avoid closing if null and hide any SQLExceptions that
	 * occur.
	 *
	 * @param conn
	 *            Connection to close.
