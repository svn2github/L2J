package l2next.commons.threading;
...
public abstract class SteppingRunnableQueueManager implements Runnable
{
	...
	/**
	 * Выбираем "степпинг" для работы задачи: если delay меньше шага выполнения, результат будет равен 1 если delay больше шага выполнения, результат
	 * будет результатом округления от деления delay / step
	 */
	...
	public void purge()
	{
		GArray<SteppingScheduledFuture<?>> purge = new GArray<SteppingScheduledFuture<?>>();
