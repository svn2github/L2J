...
public final class NpcTemplate extends CharTemplate
{
	...
	private void setType(String type)
	{
		...
		try
		{
			classType = (Class<NpcInstance>) Class.forName("l2next.gameserver.model.instances." + type + "Instance");
		}
	...
	private void setAI(String ai)
	{
		...
		try
		{
			classAI = (Class<CharacterAI>) Class.forName("l2next.gameserver.ai." + ai);
		}
		catch(ClassNotFoundException e)
		{
