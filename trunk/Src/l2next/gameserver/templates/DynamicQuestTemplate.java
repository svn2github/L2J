...
public class DynamicQuestTemplate
{
	...
	public DynamicQuestTemplate(int questId, int taskId, String questName, String questPath, String questTitle, int duration, int minLevel, int points, int nextTaskId, boolean autostart, String spawnGroup, List<Zone> zones, List<DynamicQuestDate> dates, Map<Integer, Integer> killPoints, List<StartItemHolder.StartItem> rewads, List<StartItemHolder.StartItem> eliteRewads, Map<String, String> dialogs)
	{
		_questId = questId;
		_taskId = taskId;
