...
public class PetDataTable
{
	...
	public static void deletePet(ItemInstance item, Creature owner)
	{
		...
		try
		{
			...
			for(Summon summon : owner.getPets())
			{
	...
	public static enum L2Pet
	{
		...
		private final int _minLevel; // РЈСЂРѕРІРµРЅСЊ, РЅРёР¶Рµ
		// РєРѕС‚РѕСЂРѕРіРѕ РЅРµ РјРѕР¶РµС‚
		// РѕРїСѓСЃРєР°С‚СЊСЃСЏ РїРµС‚
		private final int _addFed; // РќР° СЃРєРѕР»СЊРєРѕ РїСЂРѕС†РµРЅС‚РѕРІ
		// СѓРІРµР»РёС‡РёРІР°РµС‚СЃСЏ РїРѕР»РѕСЃРєР°
		// РµРґС‹, РїСЂРё РєРѕСЂРјР»РµРЅРёРё
