...
/**
 * Created with IntelliJ IDEA. User: Darvin Date: 05.04.12 Time: 18:37
 */
public final class SubClassTable
{
	...
	public int[] getAvailableSubClasses(Player player, int classId) // FIXME[K]
	// -
	// compared
	// all
	// second
	// class
	{
		...
		{
			ClassId subClassId = ClassId.VALUES[classId];
