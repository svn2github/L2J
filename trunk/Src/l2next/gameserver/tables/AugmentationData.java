...
public class AugmentationData
{
				...
				if("list".equalsIgnoreCase(n.getNodeName()))
				{
					for(Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
					{
						if("augmentation".equalsIgnoreCase(d.getNodeName()))
						{
							...
							_allSkills.put(augmentationId, new TriggerInfo(skillId, skillLvL, t, chance, false));
						}
					}
				}
			}
	...
	public int generateRandomAugmentation(int lifeStoneLevel, LifeStone.StoneGrade lifeStoneGrade, int bodyPart)
	{
		...
		switch(bodyPart)
		{
			...
			// TODO:////
			/**
			 * case ItemTemplate.SLOT_HAIR: case ItemTemplate.SLOT_UNDERWEAR: case ItemTemplate.SLOT_HAIRALL: return
			 * generateRandomUnderwearAugmentation(lvl, bodyPart);
			 **/
			default:
	...
	private int generateRandomWeaponAugmentation(int lifeStoneLevel, LifeStone.StoneGrade lifeStoneGrade)
	{
