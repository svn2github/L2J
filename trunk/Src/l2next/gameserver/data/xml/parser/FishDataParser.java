...
import l2next.gameserver.data.xml.holder.FishDataHolder;
import l2next.gameserver.templates.item.support.FishGroup;
import l2next.gameserver.templates.item.support.FishTemplate;
import l2next.gameserver.templates.item.support.LureTemplate;
import l2next.gameserver.templates.item.support.LureType;
