...
import l2next.gameserver.templates.npc.AbsorbInfo;
...
public final class NpcParser extends AbstractDirParser<NpcHolder>
{
	...
	public ArrayList<File> getXMLDir()
	{
		...
		files.add(new File(Config.DATAPACK_ROOT, "data/npc/"));
		return files;
	}
	...
	private RewardData parseReward(org.dom4j.Element rewardElement)
	{
		...
		{
			System.out.println("RewardData: drop itemId " + itemId + "not found");
			return new RewardData(57);
		}
