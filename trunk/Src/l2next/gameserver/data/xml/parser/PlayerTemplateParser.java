...
import l2next.gameserver.templates.player.BaseArmorDefence;
import l2next.gameserver.templates.player.BaseJewelDefence;
import l2next.gameserver.templates.player.LvlUpData;
import l2next.gameserver.templates.player.PlayerTemplate;
import l2next.gameserver.templates.player.StatAttributes;
...
public final class PlayerTemplateParser extends AbstractDirParser<PlayerTemplateHolder>
{
	...
	public ArrayList<File> getXMLDir()
	{
		...
		files.add(new File(Config.DATAPACK_ROOT, "data/pc_parameters/template_data/"));
		return files;
	}
