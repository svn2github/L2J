...
import l2next.gameserver.model.entity.residence.ResidenceFunction;
...
public final class ResidenceParser extends AbstractDirParser<ResidenceHolder>
{
	...
	public ArrayList<File> getXMLDir()
	{
		...
		files.add(new File(Config.DATAPACK_ROOT, "data/residences/"));
		return files;
	}
	...
	protected void readData(Element rootElement) throws Exception
	{
		...
		try
		{
			clazz = Class.forName("l2next.gameserver.model.entity.residence." + impl);
			@SuppressWarnings("rawtypes") Constructor constructor = clazz.getConstructor(StatsSet.class);
