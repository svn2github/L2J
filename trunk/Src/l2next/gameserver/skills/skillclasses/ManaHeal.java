...
public class ManaHeal extends Skill
{
	...
	public void useSkill(Creature activeChar, GArray<Creature> targets)
	{
		...
		for(Creature target : targets)
		{
			...
			// Обработка разницы в левелах при речардже. Учитывыется разница
			// уровня скилла и уровня цели.
			// 1013 = id скилла recharge. Для сервиторов не проверено убавление
			// маны, пока оставлено так как есть.
