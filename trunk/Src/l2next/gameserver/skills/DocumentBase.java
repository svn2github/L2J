...
import l2next.gameserver.stats.conditions.ConditionFirstEffectSuccess;
import l2next.gameserver.stats.conditions.ConditionGameTime;
import l2next.gameserver.stats.conditions.ConditionGameTime.CheckGameTime;
import l2next.gameserver.stats.conditions.ConditionHasSkill;
import l2next.gameserver.stats.conditions.ConditionLogicAnd;
import l2next.gameserver.stats.conditions.ConditionLogicNot;
import l2next.gameserver.stats.conditions.ConditionLogicOr;
import l2next.gameserver.stats.conditions.ConditionPlayerAgathion;
import l2next.gameserver.stats.conditions.ConditionPlayerClassId;
import l2next.gameserver.stats.conditions.ConditionPlayerCubic;
import l2next.gameserver.stats.conditions.ConditionPlayerHasBuff;
import l2next.gameserver.stats.conditions.ConditionPlayerHasBuffId;
import l2next.gameserver.stats.conditions.ConditionPlayerInstanceZone;
import l2next.gameserver.stats.conditions.ConditionPlayerMaxLevel;
import l2next.gameserver.stats.conditions.ConditionPlayerMaxPK;
import l2next.gameserver.stats.conditions.ConditionPlayerMinLevel;
import l2next.gameserver.stats.conditions.ConditionPlayerMinMaxDamage;
import l2next.gameserver.stats.conditions.ConditionPlayerOlympiad;
import l2next.gameserver.stats.conditions.ConditionPlayerPercentCp;
import l2next.gameserver.stats.conditions.ConditionPlayerPercentHp;
import l2next.gameserver.stats.conditions.ConditionPlayerPercentMp;
import l2next.gameserver.stats.conditions.ConditionPlayerRace;
import l2next.gameserver.stats.conditions.ConditionPlayerRiding;
import l2next.gameserver.stats.conditions.ConditionPlayerRiding.CheckPlayerRiding;
import l2next.gameserver.stats.conditions.ConditionPlayerState;
import l2next.gameserver.stats.conditions.ConditionPlayerState.CheckPlayerState;
import l2next.gameserver.stats.conditions.ConditionPlayerSummonSiegeGolem;
import l2next.gameserver.stats.conditions.ConditionSlotItemId;
import l2next.gameserver.stats.conditions.ConditionTargetAggro;
import l2next.gameserver.stats.conditions.ConditionTargetCastleDoor;
import l2next.gameserver.stats.conditions.ConditionTargetClan;
import l2next.gameserver.stats.conditions.ConditionTargetDirection;
import l2next.gameserver.stats.conditions.ConditionTargetForbiddenClassId;
import l2next.gameserver.stats.conditions.ConditionTargetHasBuff;
import l2next.gameserver.stats.conditions.ConditionTargetHasBuffId;
import l2next.gameserver.stats.conditions.ConditionTargetHasForbiddenSkill;
import l2next.gameserver.stats.conditions.ConditionTargetMob;
import l2next.gameserver.stats.conditions.ConditionTargetMobId;
import l2next.gameserver.stats.conditions.ConditionTargetNpcClass;
import l2next.gameserver.stats.conditions.ConditionTargetPercentCp;
import l2next.gameserver.stats.conditions.ConditionTargetPercentHp;
import l2next.gameserver.stats.conditions.ConditionTargetPercentMp;
import l2next.gameserver.stats.conditions.ConditionTargetPlayable;
import l2next.gameserver.stats.conditions.ConditionTargetPlayer;
import l2next.gameserver.stats.conditions.ConditionTargetPlayerRace;
import l2next.gameserver.stats.conditions.ConditionTargetRace;
import l2next.gameserver.stats.conditions.ConditionTargetSummon;
import l2next.gameserver.stats.conditions.ConditionUsingArmor;
import l2next.gameserver.stats.conditions.ConditionUsingItemType;
import l2next.gameserver.stats.conditions.ConditionUsingSkill;
import l2next.gameserver.stats.conditions.ConditionZoneType;
...
abstract class DocumentBase
{
	...
	protected void parseTrigger(Node n, StatTemplate template)
	{
		for(n = n.getFirstChild(); n != null; n = n.getNextSibling())
		{
			if("trigger".equalsIgnoreCase(n.getNodeName()))
			{
				...
				boolean cancel = (map.getNamedItem("cancel_effects_on_remove") != null) && (Boolean.valueOf(map.getNamedItem("cancel_effects_on_remove").getNodeValue()).booleanValue());
				TriggerInfo trigger = new TriggerInfo(id, level, t, chance, cancel);
	...
	protected void attachEffect(Node n, Object template)
	{
		...
		if(attrs.getNamedItem("stackType1") != null)
		{
			set.set("stackType1", attrs.getNamedItem("stackType1").getNodeValue());
		}
		if(attrs.getNamedItem("stackType2") != null)
		{
			set.set("stackType2", attrs.getNamedItem("stackType2").getNodeValue());
		}
		if(attrs.getNamedItem("stackType3") != null)
		{
	...
	protected void parseBeanSet(Node n, StatsSet set, int level)
	{
		try
		{
			...
			if(value.contains("#") && ch != '#') // кошмарная затычка на
			// таблицы в сложных строках
			// вроде triggerActions
			{
