...
public enum Stats
{
	...
	CRITICAL_BASE("baseCrit", 0., Double.POSITIVE_INFINITY, 100.), // static
	// crit
	// rate.
	// Use
	// it
	...
	// val="27.4"
	// />
	CRITICAL_RATE("rCrit", 0., Double.POSITIVE_INFINITY, 100.), // dynamic crit
	// rate. Use it
	// to MULTIPLE
	// crit for 1.3,
	// 1.5 etc.
	...
	MCRITICAL_DAMAGE_STATIC("mCritStatic"),
	...
	REFLECT_AND_BLOCK_DAMAGE_CHANCE("reflectAndBlockDam", 0., 100.), // Ближний
	// урон без
	// скиллов
	REFLECT_AND_BLOCK_PSKILL_DAMAGE_CHANCE("reflectAndBlockPSkillDam", 0., 100.), // Ближний
	// урон
	// скиллами
	REFLECT_AND_BLOCK_MSKILL_DAMAGE_CHANCE("reflectAndBlockMSkillDam", 0., 100.), // Любой
	// урон
	// магией
	...
	REFLECT_PSKILL_DAMAGE_PERCENT("reflectPSkillDam", 0., 100.), // Ближний урон
	// скиллами
	REFLECT_MSKILL_DAMAGE_PERCENT("reflectMSkillDam", 0., 100.), // Любой урон
	// магией
	...
	PHYS_SKILL_DMG_STATIC("PhysSkillDmgStatic"), // к примеру Атака умениями
	// +338.
	MAGIC_SKILL_DMG_STATIC("MagicSkillDmgStatic"), // к примеру Атака Маг.
	// умениями +338.
	...
	SUMMON_POINTS("summonPoints", 0., 10., 1.),
