...
/**
 * A calculator is created to manage and dynamically calculate the effect of a character property (ex : MAX_HP, REGENERATE_HP_RATE...). In fact, each
 * calculator is a table of Func object in which each Func represents a mathematic function : <BR>
 * <BR>
 * <p/>
...
public final class Calculator
{
	...
	public void calc(Env env)
	{
		...
		if(env.value != _last)
		{
			double last = _last; // TODO [G1ta0] найти приминение в
			// StatsChangeRecorder
			_last = env.value;
		}
	}
