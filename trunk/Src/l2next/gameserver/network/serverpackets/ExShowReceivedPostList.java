...
import l2next.gameserver.network.clientpackets.RequestExDeleteReceivedPost;
import l2next.gameserver.network.clientpackets.RequestExPostItemList;
import l2next.gameserver.network.clientpackets.RequestExRequestReceivedPost;
import l2next.gameserver.network.clientpackets.RequestExRequestReceivedPostList;
