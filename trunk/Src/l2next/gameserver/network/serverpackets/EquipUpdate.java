 ...
 * <p/>
 * body slot 0000 ?? underwear 0001 ear 0002 ear 0003 neck 0004 finger (magic ring) 0005 finger (magic ring) 0006 head (l.cap) 0007 r.hand (dagger)
 * 0008 l.hand (arrows) 0009 hands (int gloves) 000a chest (squire shirt) 000b legs (squire pants) 000c feet 000d ?? back 000e lr.hand (bow)
 * <p/>
 * format ddd
 */
@Deprecated
