...
public class EtcStatusUpdate extends L2GameServerPacket
{
	 ...
	 * <p/>
	 * Example:(C4) F9 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 - empty statusbar F9 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00
	 * 00 00 00 00 00 - increased force lvl 1 F9 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 - weight penalty lvl 1 F9 00 00 00 00 00
	 * 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 - chat banned F9 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 - Danger Area lvl 1
	 ...
	 * <p/>
	 * Example:(C5 709) F9 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 0F 00 00 00 - lvl 1 charm of courage lvl 15 Death
	 * Penalty
	 * <p/>
	 * <p/>
	 * NOTE: End of buff: You must send empty packet F9 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 to remove the statusbar or just
	 * empty value to remove some icon.
	 */
