...
public class RC4
{
	...
	/**
	 * Инициализация потока. В аргументе - Ключик потока
	 */
	...
	/**
	 * Инициализация класса с ключевыми байтами массива. Длина нормального ключ должен быть от 1 до 2048 бит. Но этот метод не проверяет длину.
	 */
