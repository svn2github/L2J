...
import l2next.gameserver.model.matching.CCMatchingRoom;
import l2next.gameserver.model.party.Party;
import l2next.gameserver.network.serverpackets.ListPartyWaiting;
...
public class RequestPartyMatchConfig extends L2GameClientPacket
{
	...
	protected void readImpl()
	{
		...
		_allLevels = readD(); // 1 -> all levels, 0 -> only levels matching my
		// level
	}
