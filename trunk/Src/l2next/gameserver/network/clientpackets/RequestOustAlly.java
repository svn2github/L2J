...
public class RequestOustAlly extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(clan != null)
		{
			...
			activeChar.sendMessage(new CustomMessage("l2next.gameserver.clientpackets.RequestOustAlly.ClanDismissed", activeChar).addString(clan.getName()).addString(alliance.getAllyName()));
		}
	}
}