...
public abstract class AbstractRefinePacket extends L2GameClientPacket
{
	...
	protected static final boolean isValid(Player player, ItemInstance item, ItemInstance refinerItem, ItemInstance gemStones)
	{
		...
		LifeStone ls = EnchantItemHolder.getInstance().getLifeStone(refinerItem.getItemId());
	...
	protected static final int getGemStoneCount(LifeStone.StoneGrade lsGrade, Grade itemGrade)
	{
		switch(lsGrade)
		{
			case ACCESSORY:
