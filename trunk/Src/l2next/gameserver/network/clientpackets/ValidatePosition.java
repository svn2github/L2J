...
public class ValidatePosition extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(h >= activeChar.getTemplate().getBaseSafeFallHeight())
		{
		...
		// TODO реализовать NetPing и вычислять предельное отклонение исходя
		// из пинга по формуле: 16 + (ping * activeChar.getMoveSpeed()) /
		// 1000
		{
