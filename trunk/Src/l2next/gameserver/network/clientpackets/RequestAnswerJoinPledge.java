...
import l2next.gameserver.network.serverpackets.JoinPledge;
import l2next.gameserver.network.serverpackets.PledgeShowInfoUpdate;
import l2next.gameserver.network.serverpackets.PledgeShowMemberListAdd;
...
public class RequestAnswerJoinPledge extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		try
		{
			...
			if(clan.getWarDominion() > 0) // баг оффа, после вступа в клан
			// нужен релог для квестов
			{
