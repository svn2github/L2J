...
public class Say2C extends L2GameClientPacket
{
	...
	protected void readImpl()
	{
		...
		_type = l2next.commons.lang.ArrayUtils.valid(ChatType.VALUES, readD());
	...
	protected void runImpl()
	{
		...
		if(_text.startsWith(".") & Config.ALT_IF_VOICE_COMMAND_ALLOWED)
		{
		...
		else if(_text.startsWith("==") & Config.ALT_IF_VOICE_COMMAND_ALLOWED)
		{
