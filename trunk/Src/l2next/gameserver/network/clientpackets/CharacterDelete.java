...
import l2next.gameserver.network.serverpackets.CharacterDeleteFail;
import l2next.gameserver.network.serverpackets.CharacterDeleteSuccess;
...
public class CharacterDelete extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		// WTF? oO
		// if(CommissionManager.getInstance().getAllItemsForPlayer(getClient().getObjectIdForSlot(_charSlot))
		// != null)
		// return;
