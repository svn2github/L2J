	...
	protected void runImpl()
	{
		...
		try
		{
			...
			for(int i = 0; i < _count; i++)
			{
				...
				{
					buyer.sendMessage(new CustomMessage("l2next.gameserver.clientpackets.SetPrivateStoreBuyList.TooLowPrice", buyer).addItemName(item).addNumber(item.getReferencePrice() / 2));
					continue;
				}
