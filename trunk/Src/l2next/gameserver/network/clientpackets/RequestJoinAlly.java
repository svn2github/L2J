...
import l2next.gameserver.network.serverpackets.AskJoinAlliance;
...
public class RequestJoinAlly extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("l2next.gameserver.clientpackets.RequestJoinAlly.InvitePenalty", activeChar));
			return;
		}
