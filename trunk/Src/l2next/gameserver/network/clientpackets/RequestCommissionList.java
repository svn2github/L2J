 ...
 * @author : Darvin
 *         <p/>
 *         Приходит при нажатии на какую либо категорию/подкатегорию в списке продаж, либо при нажатии кнопки "Поиск" Отправляет пакет
 *         ExResponseCommissionList, с параметром type = 3 (ALL_ITEMS)
 */
public class RequestCommissionList extends L2GameClientPacket
{
	...
	protected void readImpl() throws Exception
	{
		...
		listType = readD();
		// Category.
		// Если предыдущее 1, то определяет тип отображаемой категории. Оружие =
		// 0, доспехи = 1, итд.
		// Если предыдущее 2, значит была нажата определенная категория, и здесь
		// приходит тип этой под-категории.
		category = readD();
