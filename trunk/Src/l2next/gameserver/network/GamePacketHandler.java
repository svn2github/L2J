...
import l2next.commons.net.nio.impl.IClientFactory;
import l2next.commons.net.nio.impl.IMMOExecutor;
...
import l2next.gameserver.network.clientpackets.*;
import l2next.gameserver.network.clientpackets.Beautyshop.NotifyExitBeautyshop;
import l2next.gameserver.network.clientpackets.Beautyshop.RequestRegistBeauty;
import l2next.gameserver.network.clientpackets.Beautyshop.RequestResetBeauty;
import l2next.gameserver.network.clientpackets.Beautyshop.RequestShowBeautyList;
import l2next.gameserver.network.clientpackets.CuriousHouse.RequestCancelCuriousHouse;
import l2next.gameserver.network.clientpackets.CuriousHouse.RequestClanAskJoinByName;
import l2next.gameserver.network.clientpackets.CuriousHouse.RequestCuriousHouseHtml;
import l2next.gameserver.network.clientpackets.CuriousHouse.RequestCuriousHouseRecord;
import l2next.gameserver.network.clientpackets.CuriousHouse.RequestInzoneWaitingTime;
import l2next.gameserver.network.clientpackets.CuriousHouse.RequestJoinCuriousHouse;
import l2next.gameserver.network.clientpackets.CuriousHouse.RequestLeaveCuriousHouse;
import l2next.gameserver.network.clientpackets.CuriousHouse.RequestLeaveObservingCuriousHouse;
import l2next.gameserver.network.clientpackets.CuriousHouse.RequestObservingCuriousHouse;
import l2next.gameserver.network.clientpackets.CuriousHouse.RequestObservingListCuriousHouse;
import l2next.gameserver.network.clientpackets.PledgeRecruit.RequestPledgeDraftListApply;
import l2next.gameserver.network.clientpackets.PledgeRecruit.RequestPledgeDraftListSearch;
import l2next.gameserver.network.clientpackets.PledgeRecruit.RequestPledgeJoinSys;
import l2next.gameserver.network.clientpackets.PledgeRecruit.RequestPledgeRecruitApplyInfo;
import l2next.gameserver.network.clientpackets.PledgeRecruit.RequestPledgeRecruitBoardAccess;
import l2next.gameserver.network.clientpackets.PledgeRecruit.RequestPledgeRecruitBoardDetail;
import l2next.gameserver.network.clientpackets.PledgeRecruit.RequestPledgeRecruitBoardSearch;
import l2next.gameserver.network.clientpackets.PledgeRecruit.RequestPledgeRecruitInfo;
import l2next.gameserver.network.clientpackets.PledgeRecruit.RequestPledgeWaitingApplied;
import l2next.gameserver.network.clientpackets.PledgeRecruit.RequestPledgeWaitingApply;
import l2next.gameserver.network.clientpackets.PledgeRecruit.RequestPledgeWaitingList;
import l2next.gameserver.network.clientpackets.PledgeRecruit.RequestPledgeWaitingUser;
import l2next.gameserver.network.clientpackets.PledgeRecruit.RequestPledgeWaitingUserAccept;
import l2next.gameserver.network.clientpackets.Test_packet.d0de;
import l2next.gameserver.network.clientpackets.UnionPledge.*;
				...
				case IN_GAME:
					switch(id)
					{
						...
						case 0x31:
							...
							//_log.info("SetPrivateStoreSellList");
							break;
						case 0x32:
						...
						case 0x82:
							...
							//_log.info("RequestPrivateStoreList");
							break;
						case 0x83:
							msg = new RequestPrivateStoreBuy();
							//_log.info("RequestPrivateStoreBuy");
							break;
						case 0x84:
						...
						case 0x96:
							...
							//_log.info("RequestPrivateStoreQuitSell");
							break;
						case 0x97:
							msg = new SetPrivateStoreMsgSell();
							//_log.info("SetPrivateStoreMsgSell");
							break;
						case 0x98:
						...
						case 0x99:
							...
							//_log.info("RequestPrivateStoreBuyManage");
							break;
						case 0x9a:
							msg = new SetPrivateStoreBuyList();
							//_log.info("SetPrivateStoreBuyList");
							break;
						case 0x9b:
							//
							_log.info("0x9b");
						...
						case 0x9c:
							...
							//_log.info("RequestPrivateStoreQuitBuy");
							break;
						case 0x9d:
							msg = new SetPrivateStoreMsgBuy();
							//_log.info("RequestPrivateMsgBuy");
							break;
						case 0x9e:
							//
							_log.info("0x9e");
						...
						case 0x9f:
							...
							//_log.info("RequestPrivateStoreBuySellList");
							break;
						case 0xa0:
						...
						case 0xd0:
							...
							switch(id3)
							{
								...
								case 0x0F:
									...
									break;
								case 0x10:
									//	msg = new RequestPledgeCrestLarge(); TODO Не работает
									break;
								case 0x11:
								...
								case 0x47:
									...
									//_log.info("SetPrivateStoreWhole");
									break;
								case 0x48:
								...
								case 0xDF:
									...
									switch(id8)
									{
										case 0x02:
											...
											msg = new RequestEventCampaignQuestHTML();
											break;
										case 0x03:
											_log.info("RequestEventCampaignProgressInfo(cdd)");
											msg = new RequestEventCampaignProgressInfo();
											break;
										case 0x04:
											_log.info("RequestEventCampaignScoreBoard(cdd)");
											msg = new RequestEventCampaignScoreBoard();
											break;
										default:
											client.onUnknownPacket();
											_log.warn("Unknown packet on state: CONNECTED, id: " + Integer.toHexString(id) + " from " + client.getConnection().getSocket().getInetAddress().getHostAddress());
