...
import static l2next.gameserver.model.Zone.ZoneType.no_restart;
import static l2next.gameserver.model.Zone.ZoneType.no_summon;
...
public class Wedding implements IVoicedCommandHandler
{
	private static class CoupleAnswerListener implements OnAnswerListener
	{
		...
		public void sayYes()
		{
			...
			player1.sendMessage(new CustomMessage("l2next.gameserver.model.L2Player.EngageAnswerYes", player2));
		}
		...
		public void sayNo()
		{
			...
			player1.sendMessage(new CustomMessage("l2next.gameserver.model.L2Player.EngageAnswerNo", player2));
		}
	}
	...
	public boolean goToLove(Player activeChar)
	{
		...
		if(activeChar.isInParty() || partner.isInParty())
		{
			activeChar.sendMessage(new CustomMessage("common.TryLater", activeChar));
			return false;
		}
