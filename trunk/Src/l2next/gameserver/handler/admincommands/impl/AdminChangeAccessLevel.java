...
import l2next.gameserver.utils.Files;
...
/**
 * changelvl - Изменение уровня доступа moders - Панель управления модераторами moders_add - Добавление модератора moders_del - Удаление модератора
	...
	public boolean useAdminCommand(Enum comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		switch(command)
		{
			...
			case admin_moders_del:
				...
				// Если удаляемый модератор онлайн, то отбираем у него права на
				// ходу
			...
			case admin_penalty:
				...
				{
					// TODO: Не плохо было бы сделать сперва проверку, модератор
					// это или нет.
