package l2next.gameserver.handler.usercommands.impl;
...
import l2next.gameserver.network.serverpackets.ExMultiPartyCommandChannelInfo;
	...
	public boolean useUserCommand(int id, Player activeChar)
	{
		...
		switch(id)
		{
			...
			case 93: // channeldelete
				...
				{
					l2next.gameserver.model.CommandChannel channel = activeChar.getParty().getCommandChannel();
			...
			case 96: // channelleave
				// FIXME создатель канала вылетел, надо автоматом передать
				// кому-то права
				if(!activeChar.isInParty() || !activeChar.getParty().isInCommandChannel())
				{
					return true;
				...
				// FIXME по идее может, права автоматом должны передаться другой
				// партии
