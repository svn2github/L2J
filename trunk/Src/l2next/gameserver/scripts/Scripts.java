package l2next.gameserver.scripts;
...
import l2next.commons.compiler.Compiler;
import l2next.commons.compiler.MemoryClassLoader;
...
public class Scripts {
    ...
    private void load() {
        ...
        File f = new File("../serverslibs/L2NT-Scripts.jar");
        if (f.exists()) {
            _log.info("Loading L2NT-Scripts.jar");
            ...
            try {
                ...
                _log.error("Fail to load L2NT-Scripts.jar!", e);
                jarClasses.clear();
            } finally {
