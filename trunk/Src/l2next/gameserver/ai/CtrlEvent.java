...
public enum CtrlEvent
{
	...
	EVT_THINK,
	/**
	 * The actor was attacked. This event comes each time a physical or magical attack was done on the actor. NPC may start attack in responce, or
	 * ignore this event if they already attack someone, or change target and so on.
	 */
	...
	EVT_AGGRESSION,
	/**
	 * An event that previous action was completed. The action may be an attempt to physically/magically hit an enemy, or an action that discarded
	...
	EVT_FINISH_CASTING, EVT_SEE_SPELL, EVT_SPAWN, EVT_DESPAWN, EVT_TIMER, EVT_TELEPORTED, EVT_MENU_SELECTED, EVT_SCRIPT_EVENT
}
