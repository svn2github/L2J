	...
	void checkAndSetCurrentAndNextAuction()
	{
		...
		switch(auctions.length)
		{
			...
			default:
			{
				...
				// just to make sure we won`t skip any auction because of little
				// different times
		...
		public void runImpl() throws Exception
		{
			...
			switch(state)
			{
				case CREATED:
				{
					...
					{
						String[] params = {};
						Announcements.getInstance().announceByCustomMessage("l2next.gameserver.model.instances.L2ItemAuctionBrokerInstance.announce." + _auction.getInstanceId(), params);
					}
					checkAndSetCurrentAndNextAuction();
					break;
				}
