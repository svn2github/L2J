...
public class CoupleManager
{
	...
	public void notifyPartner(Player cha)
	{
		if(cha.getPartnerId() != 0)
		{
			...
			if(partner != null)
			{
				partner.sendMessage(new CustomMessage("l2next.gameserver.instancemanager.CoupleManager.PartnerEntered", partner));
			}
		}
	}
	...
	/**
	 * Вызывется при шатдауне Сначала очищаем таблицу от ненужных свадеб, потом загоняем в нее все нужные. Обращение происходит только при
	 * загрузке/шатдауне сервера, ну или по запросу
	 */
	public void store()
	{
		Connection con = null;
