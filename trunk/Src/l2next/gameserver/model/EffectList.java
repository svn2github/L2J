...
public class EffectList
{
	...
	public static boolean checkStackType(EffectTemplate ef1, EffectTemplate ef2)
	{
		if ((!ef1._stackTypes.equals(EffectTemplate.NO_STACK)) && (ef1._stackTypes.equalsIgnoreCase(ef2._stackTypes)))
		{
			return true;
		}
		if ((!ef1._stackTypes.equals(EffectTemplate.NO_STACK)) && (ef1._stackTypes.equalsIgnoreCase(ef2._stackTypes1)))
		{
			return true;
		}
		if ((!ef1._stackTypes1.equals(EffectTemplate.NO_STACK)) && (ef1._stackTypes1.equalsIgnoreCase(ef2._stackTypes)))
		{
			return true;
		}
		if ((!ef1._stackTypes1.equals(EffectTemplate.NO_STACK)) && (ef1._stackTypes1.equalsIgnoreCase(ef2._stackTypes1)))
		{
			return true;
		}
		
		if ((!ef1._stackTypes2.equals(EffectTemplate.NO_STACK)) && (ef1._stackTypes2.equalsIgnoreCase(ef2._stackTypes2)))
		{
			return true;
		}
		if ((!ef1._stackTypes2.equals(EffectTemplate.NO_STACK)) && (ef1._stackTypes2.equalsIgnoreCase(ef2._stackTypes3)))
		{
			return true;
		}
		if ((!ef1._stackTypes3.equals(EffectTemplate.NO_STACK)) && (ef1._stackTypes1.equalsIgnoreCase(ef2._stackTypes2)))
		{
			return true;
		}
		if ((!ef1._stackTypes3.equals(EffectTemplate.NO_STACK)) && (ef1._stackTypes1.equalsIgnoreCase(ef2._stackTypes3)))
		{
			return true;
		}
		return false;
	...
	public void addEffect(Effect effect)
	{
		...
		try
		{
			...
			// Проверяем, нужно ли накладывать эффект, при совпадении
			// StackType.
