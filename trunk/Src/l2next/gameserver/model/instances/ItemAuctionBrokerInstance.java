...
import l2next.gameserver.instancemanager.itemauction.ItemAuction;
import l2next.gameserver.instancemanager.itemauction.ItemAuctionInstance;
import l2next.gameserver.instancemanager.itemauction.ItemAuctionManager;
import l2next.gameserver.model.Player;
import l2next.gameserver.network.serverpackets.ExItemAuctionInfo;
	...
	public final void onBypassFeedback(Player player, String command)
	{
		...
		if(params[0].equals("auction"))
		{
			if(_instance == null)
			{
				...
				if(_instance == null)
				// _log.error("L2ItemAuctionBrokerInstance: Missing instance for: "
				// + getTemplate().npcId);
				{
					return;
				}
