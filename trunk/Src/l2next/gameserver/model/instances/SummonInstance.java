...
import l2next.gameserver.network.serverpackets.SetSummonRemainTime;
...
{
	private static final long serialVersionUID = -1094018173212922171L;
	...
	{
		return WeaponType.SWORD.mask(); // TODO: читать пассивки и смотреть тип
		// оружия и брони там
	}
	...
	{
		return SummonPointsHolder.getInstance().getPointsForSummonId(getNpcId());
	}
}