...
import l2next.gameserver.model.entity.Couple;
...
public class WeddingManagerInstance extends NpcInstance
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 3867447506025670714L;
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if(command.startsWith("AcceptWedding"))
		{
			...
			player.sendMessage(new CustomMessage("l2next.gameserver.model.instances.L2WeddingManagerMessage", player));
			player.setMaried(true);
			player.setMaryRequest(false);
			ptarget.sendMessage(new CustomMessage("l2next.gameserver.model.instances.L2WeddingManagerMessage", ptarget));
			...
			Announcements.getInstance().announceByCustomMessage("l2next.gameserver.model.instances.L2WeddingManagerMessage.announce", new String[]{
				player.getName(),
				ptarget.getName()
			});
