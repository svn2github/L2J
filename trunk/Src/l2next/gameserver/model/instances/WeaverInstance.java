...
public class WeaverInstance extends MerchantInstance
{
	 ...
	 *
	 */
	private static final long serialVersionUID = -1938186926294826655L;
		...
		if(actualCommand.equalsIgnoreCase("unseal"))
		{
			...
			switch(id)
			{
				case 13898: // Sealed Magic Pin (C-Grade)
					...
					else if(chance < 550000) // Mid-Grade Magic Pin (C-Grade)
					// 20%
					{
						ItemFunctions.addItem(player, 13903, 1, true);
					}
					else if(chance < 650000) // High-Grade Magic Pin (C-Grade)
					// 10%
					{
						ItemFunctions.addItem(player, 13904, 1, true);
					}
					else if(chance < 730000) // Top-Grade Magic Pin (C-Grade)
					// 8%
					{
				...
				case 13899: // Sealed Magic Pin (B-Grade)
					...
					else if(chance < 550000) // Mid-Grade Magic Pin (B-Grade)
					// 20%
					{
						ItemFunctions.addItem(player, 13907, 1, true);
					}
					else if(chance < 650000) // High-Grade Magic Pin (B-Grade)
					// 10%
					{
						ItemFunctions.addItem(player, 13908, 1, true);
					}
					else if(chance < 730000) // Top-Grade Magic Pin (B-Grade)
					// 8%
					{
				...
				case 13900: // Sealed Magic Pin (A-Grade)
					...
					else if(chance < 650000) // High-Grade Magic Pin (A-Grade)
					// 10%
					{
						ItemFunctions.addItem(player, 13912, 1, true);
					}
					else if(chance < 730000) // Top-Grade Magic Pin (A-Grade)
					// 8%
					{
				...
				case 13901: // Sealed Magic Pin (S-Grade)
					...
					else if(chance < 550000) // Mid-Grade Magic Pin (S-Grade)
					// 20%
					{
						ItemFunctions.addItem(player, 13915, 1, true);
					}
					else if(chance < 650000) // High-Grade Magic Pin (S-Grade)
					// 10%
					{
						ItemFunctions.addItem(player, 13916, 1, true);
					}
					else if(chance < 730000) // Top-Grade Magic Pin (S-Grade)
					// 8%
					{
				...
				case 13918: // Sealed Magic Pouch (C-Grade)
					...
					else if(chance < 550000) // Mid-Grade Magic Pouch (C-Grade)
					// 20%
					{
						ItemFunctions.addItem(player, 13923, 1, true);
					}
					else if(chance < 650000) // High-Grade Magic Pouch
					// (C-Grade) 10%
					{
						ItemFunctions.addItem(player, 13924, 1, true);
					}
					else if(chance < 730000) // Top-Grade Magic Pouch (C-Grade)
					// 8%
					{
				...
				case 13919: // Sealed Magic Pouch (B-Grade)
					...
					else if(chance < 550000) // Mid-Grade Magic Pouch (B-Grade)
					// 20%
					{
					...
					else if(chance < 730000) // Top-Grade Magic Pouch (B-Grade)
					// 8%
					{
				...
				case 13920: // Sealed Magic Pouch (A-Grade)
					...
					else if(chance < 550000) // Mid-Grade Magic Pouch (A-Grade)
					// 20%
					{
					...
					else if(chance < 730000) // Top-Grade Magic Pouch (A-Grade)
					// 8%
					{
				...
				case 13921: // Sealed Magic Pouch (S-Grade)
					...
					else if(chance < 550000) // Mid-Grade Magic Pouch (S-Grade)
					// 20%
					{
					...
					else if(chance < 730000) // Top-Grade Magic Pouch (S-Grade)
					// 8%
					{
				...
				case 14902: // Sealed Magic Rune Clip (A-Grade)
					if(chance < 350000) // Low-level Magic Rune Clip (A-Grade)
					// 35%
					{
						ItemFunctions.addItem(player, 14906, 1, true);
					}
					else if(chance < 550000) // Mid-level Magic Rune Clip
					// (A-Grade) 20%
					{
						ItemFunctions.addItem(player, 14907, 1, true);
					}
					else if(chance < 650000) // High-level Magic Rune Clip
					// (A-Grade) 10%
					{
						ItemFunctions.addItem(player, 14908, 1, true);
					}
					else if(chance < 730000) // Top-level Magic Rune Clip
					// (A-Grade) 8%
					{
				...
				case 14903: // Sealed Magic Rune Clip (S-Grade)
					if(chance < 350000) // Low-level Magic Rune Clip (S-Grade)
					// 35%
					{
				...
				case 14904: // Sealed Magic Ornament (A-Grade)
					if(chance < 350000) // Low-grade Magic Ornament (A-Grade)
					// 35%
					{
						ItemFunctions.addItem(player, 14914, 1, true);
					}
					else if(chance < 550000) // Mid-grade Magic Ornament
					// (A-Grade) 20%
					{
						ItemFunctions.addItem(player, 14915, 1, true);
					}
					else if(chance < 650000) // High-grade Magic Ornament
					// (A-Grade) 10%
					{
						ItemFunctions.addItem(player, 14916, 1, true);
					}
					else if(chance < 730000) // Top-grade Magic Ornament
					// (A-Grade) 8%
					{
				...
				case 14905: // Sealed Magic Ornament (S-Grade)
					if(chance < 350000) // Low-grade Magic Ornament (S-Grade)
					// 35%
					{
