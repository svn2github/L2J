...
import l2next.gameserver.network.serverpackets.IconEffectPacket;
...
import l2next.gameserver.stats.funcs.FuncOwner;
...
public abstract class Effect extends RunnableImpl implements Comparable<Effect>, FuncOwner
{
	...
	public String getStackType1()
	{
		return getTemplate()._stackTypes1;
	}
	
	public String getStackType2()
	{
		return getTemplate()._stackTypes2;
	}
	
	public String getStackType3()
	{
		return getTemplate()._stackTypes3;
	}

	public boolean checkStackType(String param)
	{
		return getStackType().contains(param) || getStackType1().contains(param) || getStackType2().contains(param) || getStackType3().contains(param);
	}
	...
	public boolean checkStackType(Effect param)
	{
		...
		//}
		//return r;
		return checkStackType(param.getStackType()) || checkStackType(param.getStackType1()) || checkStackType(param.getStackType2()) || checkStackType(param.getStackType3());
	}
	...
	protected void onStart()
	{
		...
		getEffected().useTriggers(getEffected(), TriggerType.ON_START_EFFECT, null, _skill, 0.0D);
	...
	protected void onExit()
	{
		...
		getEffected().useTriggers(getEffected(), TriggerType.ON_EXIT_EFFECT, null, _skill, 0.0D);
