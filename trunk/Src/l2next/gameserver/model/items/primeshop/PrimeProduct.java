...
public class PrimeProduct
{
	...
	private ArrayList<PrimeItem> _components;

	public PrimeProduct(int productId, int category, int points, int tabId, long startTimeSale, long endTimeSale)
	{
	...
	public void setComponents(ArrayList<PrimeItem> a)
	{
		_components = a;
	}

	public ArrayList<PrimeItem> getComponents()
	{
		if(_components == null)
		{
			_components = new ArrayList<PrimeItem>();
		}
