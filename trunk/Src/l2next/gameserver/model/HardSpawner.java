...
public class HardSpawner extends Spawner
{
	 ...
	 *
	 */
	private static final long serialVersionUID = -1752511804214480210L;
	...
	{
		oldNpc.setSpawn(null); // [VISTALL] нужно убирать спавн что бы не
		// вызвать зацикливания, и остановки спавна
		oldNpc.deleteMe();
