...
import l2next.gameserver.model.instances.NpcFriendInstance;
...
import l2next.gameserver.network.serverpackets.ExMPCCPartyInfoUpdate;
...
public class CommandChannel implements PlayerGroup
{
	...
	{
		// CC могут создавать только лидеры партий, состоящие в клане ранком не
		// ниже барона
