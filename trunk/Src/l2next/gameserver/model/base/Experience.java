...
public class Experience
{
	 ...
	 * 
	 * public final static double penaltyModifier(int count, int percents) { int allPercents = 100; int allSubstructedPercents = count * percents; int
	 * penaltyInPercents = allPercents - allSubstructedPercents; double penalty = penaltyInPercents / 100.0; return penalty; }
	 */
