...
public enum Element
{
	FIRE(0, Stats.ATTACK_FIRE, Stats.DEFENCE_FIRE, 1), WATER(1, Stats.ATTACK_WATER, Stats.DEFENCE_WATER, 2), WIND(2, Stats.ATTACK_WIND, Stats.DEFENCE_WIND, 4), EARTH(3, Stats.ATTACK_EARTH, Stats.DEFENCE_EARTH, 8), HOLY(4, Stats.ATTACK_HOLY, Stats.DEFENCE_HOLY, 16), UNHOLY(5, Stats.ATTACK_UNHOLY, Stats.DEFENCE_UNHOLY, 32), NONE(-2, null, null, 0);
