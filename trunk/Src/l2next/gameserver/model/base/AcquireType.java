...
{
	NORMAL, FISHING, CLAN, SUB_UNIT, TRANSFORMATION, CERTIFICATION, CERTIFICATION_DOUBLE, COLLECTION, TRANSFER_CARDINAL, TRANSFER_EVA_SAINTS, TRANSFER_SHILLIEN_SAINTS;
