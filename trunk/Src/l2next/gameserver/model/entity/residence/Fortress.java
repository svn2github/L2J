...
import l2next.gameserver.dao.FortressDAO;
...
public class Fortress extends Residence
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 3681716946122237783L;

	private static final Logger _log = LoggerFactory.getLogger(Fortress.class);

	private static final long REMOVE_CYCLE = 7 * 24; // 7 дней форт может
	// пренадлежать овнеру
