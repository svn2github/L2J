...
import l2next.gameserver.dao.ClanHallDAO;
...
public class ClanHall extends Residence
{
	...
	private static final int REWARD_CYCLE = 168; // 1 недели - 7 дней - 168
	// часов
	...
	private void updateOwnerInDB(Clan clan)
	{
		...
		try
		{
			...
			if(clan != null)
			{
				clan.setHasHideout(getId()); // Set has hideout flag for new
				// owner
