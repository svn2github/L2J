...
import l2next.gameserver.dao.CastleDamageZoneDAO;
import l2next.gameserver.dao.CastleDoorUpgradeDAO;
...
import l2next.gameserver.model.entity.HeroDiary;
...
import l2next.gameserver.model.entity.events.objects.SpawnSimpleObject;
...
public class CastleSiegeEvent extends SiegeEvent<Castle, SiegeClanObject>
{
	...
	/**
	 * Ставит осадное время вручну, вызывается с пакета {@link l2next.gameserver.clientpackets.RequestSetCastleSiegeTime}
	 *
	 * @param id
	 */
