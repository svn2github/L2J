...
import l2next.gameserver.dao.DominionRewardDAO;
...
import l2next.gameserver.network.serverpackets.ExDominionWarEnd;
...
public class DominionSiegeEvent extends SiegeEvent<Dominion, SiegeClanObject>
{
	...
	public SystemMsg checkForAttack(Creature target, Creature attacker, Skill skill, boolean force)
	{
		...
		{
			return /*
					 * skill == null ? SystemMsg. THIS_TYPE_OF_ATTACK_IS_PROHIBITED_WHEN_ALLIED_TROOPS_ARE_THE_TARGET :
					 */SystemMsg.YOU_CANNOT_FORCE_ATTACK_A_MEMBER_OF_THE_SAME_TERRITORY;
		}
