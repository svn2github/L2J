...
import l2next.gameserver.model.entity.events.impl.BoatWayEvent;
import l2next.gameserver.model.entity.events.objects.BoatPoint;
import l2next.gameserver.model.instances.ControlKeyInstance;
import l2next.gameserver.model.pledge.Clan;
import l2next.gameserver.network.serverpackets.DeleteObject;
...
import l2next.gameserver.templates.AirshipDock;
...
public class ClanAirShip extends AirShip
{
	 ...
	 *
	 */
	private static final long serialVersionUID = -3150614868860414969L;
