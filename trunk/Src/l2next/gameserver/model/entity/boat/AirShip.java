...
import l2next.gameserver.network.serverpackets.ExAirShipInfo;
import l2next.gameserver.network.serverpackets.ExGetOffAirShip;
import l2next.gameserver.network.serverpackets.ExGetOnAirShip;
import l2next.gameserver.network.serverpackets.ExMoveToLocationAirShip;
import l2next.gameserver.network.serverpackets.ExMoveToLocationInAirShip;
import l2next.gameserver.network.serverpackets.ExStopMoveAirShip;
import l2next.gameserver.network.serverpackets.ExStopMoveInAirShip;
import l2next.gameserver.network.serverpackets.ExValidateLocationInAirShip;
