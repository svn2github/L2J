...
import l2next.gameserver.model.entity.events.impl.ShuttleWayEvent;
import l2next.gameserver.network.serverpackets.ExMTLInShuttlePacket;
import l2next.gameserver.network.serverpackets.ExShuttleGetOffPacket;
import l2next.gameserver.network.serverpackets.ExShuttleGetOnPacket;
import l2next.gameserver.network.serverpackets.ExShuttleInfoPacket;
import l2next.gameserver.network.serverpackets.ExShuttleMovePacket;
import l2next.gameserver.network.serverpackets.ExStopMoveInShuttlePacket;
import l2next.gameserver.network.serverpackets.ExValidateLocationInShuttlePacket;
