...
public class Hero
{
	...
	private static Map<Integer, String> _heroMessage; // TODO [VISTALL] унести в
	// StatsSet с каждого
	// героя

	// delete hero items
	private static final String DELETE_ITEMS = "DELETE FROM items WHERE item_id IN " + "(6842, 30392, 30393, 30394, 30395, 30396, 30397, 30398, 30399, 30400, 30401, 30402, 30403, 30404, 30405)" + "AND owner_id";
