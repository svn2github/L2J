package l2next.gameserver.model.pledge;

import l2next.commons.collections.JoinedIterator;
...
import l2next.gameserver.model.items.ClanWarehouse;
...
import l2next.gameserver.network.serverpackets.PledgeShowMemberListAll;
...
import l2next.gameserver.network.serverpackets.PledgeSkillListAdd;
...
public class Clan implements Iterable<UnitMember>
{
	...
	public static final int CP_CL_WAREHOUSE_SEARCH = 8; // View warehouse
	// content
	...
	public static final int CP_CS_DISMISS = 1048576; // Выгнать чужаков из
	// замка/форта
	...
	/**
	 * Удаляет скилл у клана, без удаления из базы. Используется для удаления скилов резиденций. После удаления скила(ов) необходимо разослать
