...
import l2next.gameserver.model.entity.events.EventOwner;
...
public abstract class GameObject extends EventOwner
{
	 ...
	 * <B><U> Concept</U> :</B><BR>
	 * <BR>
	 * A L2Object is invisible if <B>_isVisible</B>=false or <B>_worldregion</B>==null <BR>
	 * <BR>
	 *
	...
	/**
	 * Удаляет объект из текущего региона, делая его невидимым. Не путать с deleteMe. Объект после decayMe подлежит реюзу через spawnMe. Если
	 * перепутать будет утечка памяти.
	 */
	 ...
	 * <li>Для L2Player это сам игрок.</li> <li>Для L2Summon это его хозяин.</li> <BR>
	 * <BR>
	 *
