...
public class AggroList
{
	...
	public GArray<Creature> getHateList()
	{
		AggroInfo[] hated;
		...
		GArray<Creature> hateList = new GArray<Creature>();
		GArray<Creature> chars = World.getAroundCharacters(npc);
		AggroInfo ai;
	...
	public Creature getRandomHated()
	{
		...
		GArray<Creature> randomHated = new GArray<Creature>();
	...
	public Map<Playable, HateInfo> getPlayableMap()
	{
		...
		GArray<Playable> chars = World.getAroundPlayables(npc);
		readLock.lock();
		try
		{
			AggroInfo ai;
