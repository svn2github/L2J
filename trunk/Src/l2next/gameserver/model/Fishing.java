...
import l2next.gameserver.network.serverpackets.ExFishingEnd;
import l2next.gameserver.network.serverpackets.ExFishingHpRegen;
import l2next.gameserver.network.serverpackets.ExFishingStart;
import l2next.gameserver.network.serverpackets.ExFishingStartCombat;
...
public class Fishing
{
	...
	public static int getRandomFishType(int lureId)
	{
		...
		switch(lureId)
		{
			case 7807: // Green Colored Lure - For Beginners, preferred by
				// fast-moving (nimble) fish (type 5)
				if(check <= 54)
				{
					type = 5;
				}
				...
				break;
			case 7808: // Purple Colored Lure - For Beginners, preferred by fat
				// fish (type 4)
				if(check <= 54)
				{
					type = 4;
				...
				break;
			case 7809: // Yellow Colored Lure - For Beginners, preferred by ugly
				// fish (type 6)
				if(check <= 54)
				{
					type = 6;
			...
			case 8548: // Hot Springs Lure
				type = 3;
				break;
			// all theese lures (green) are prefered by fast-moving (nimble)
			// fish (type 1)
			...
			case 8484: // Prize-Winning Fishing Lure
				...
				break;
			case 8506: // Green Luminous Lure, preferred by fast-moving (nimble)
				// fish (type 8)
				if(check <= 54)
				{
					type = 8;
			...
			case 8512: // Yellow Luminous Lure, preferred by ugly fish (type 9)
				...
				break;
			case 8485: // Prize-Winning Night Fishing Lure, prize-winning
				// fishing lure
				if(check <= 33)
				{
					type = 7;
