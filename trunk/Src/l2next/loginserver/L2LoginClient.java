...
import l2next.loginserver.crypt.LoginCrypt;
import l2next.loginserver.crypt.ScrambledKeyPair;
import l2next.loginserver.serverpackets.AccountKicked;
import l2next.loginserver.serverpackets.AccountKicked.AccountKickedReason;
import l2next.loginserver.serverpackets.L2LoginServerPacket;
import l2next.loginserver.serverpackets.LoginFail;
import l2next.loginserver.serverpackets.LoginFail.LoginFailReason;
...
public final class L2LoginClient extends MMOClient<MMOConnection<L2LoginClient>>
{
	...
	{
		CONNECTED, AUTHED_GG, AUTHED, DISCONNECTED
	}
