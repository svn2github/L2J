package l2next.loginserver.crypt;
...
public class NewCrypt
{
	...
	/**
	 * Packet is first XOR encoded with <code>key</code> Then, the last 4 bytes are overwritten with the the XOR "key". Thus this assume that there is
