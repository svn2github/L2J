package l2next.loginserver.accounts;

import l2next.commons.dbutils.DbUtils;
import l2next.commons.net.utils.Net;
import l2next.commons.net.utils.NetList;
import l2next.loginserver.database.L2DatabaseFactory;
...
public class Account
{
	...
	public void setPremiumPoint(int value)
	{
		_points = value;
		rePoint();
	}
	...
	public void rePoint()
	{
		...
		try
		{
			...
			statement.setInt(1, getPremiumPoint());
	...
	public void restore()
	{
		...
		try
		{
			...
			if(rset.next())
			{
				...
				setPremiumPoint(rset.getInt("points"));
			}
		}
		catch(Exception e)
		{
	...
	public void update()
	{
		...
		try
		{
			...
			statement.setInt(10, getPremiumPoint());
