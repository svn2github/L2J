...
public class Extractable extends SimpleItemHandler
{
	private static final int[] ITEM_IDS = new int[]{
		...
		21422,
		21241,
		// by CosMosiS end line
		20635,
		// by SmokiMo start line
		20636,
		20637,
		20638,
		// by SmokiMo end line
		...
		32797,
		// мешок с доспехом Р99
		32796,
		// мешок с доспехом Р95
		32795,
		// мешок с доспехом Р
		32794,
		// мешок с доспехом S
		...
		32779,
		//Start Awakeninger: Мешки с усилками
		32781,
		32780,
		34861,
		32240,
		...
		32242,
		32228,
		//Finish Awakeninger: Мешки с усилками
		35649
	...
	private void use35649(Player player, boolean ctrl)
    {   
	
	    if(Rnd.chance(100))
	    {
		    Functions.addItem(player, 34989, 1);
		}		
    }
	...
	{
		/**
		 * @Author: JustForFun (R99-Grade)
		 * @Date: 29.03.2013 21:26
		 * @Correct: JustForFun P.S под пивко шло збс 
		 */
		if(Rnd.chance(15))
		// itemId, count
		{
	...
	{
		/**
		 * @Author: JustForFun (R95-Grade)
		 * @Date: 29.03.2013 21:31
		 * @Correct: JustForFun P.S под пивко шло збс 
		 */
		if(Rnd.chance(15))
		// itemId, count
	...
	{
		/**
		 * @Author: JustForFun (R-Grade)
		 * @Date: 29.03.2013 21:35
		 * @Correct: JustForFun P.S и тут я ахуел сколько мне еще предстоит исправить
		 */
		if(Rnd.chance(15))
		// itemId, count
		{
	...
	{
		/**
		 * @Author: JustForFun (S-Grade)
		 * @Date: 29.03.2013 22:58
		 * @Correct: JustForFun P.S тут еще нормально,вот дальше C и D Grade.........
		 */
		if(Rnd.chance(15))
		// itemId, count
		{
	...
	{
		/**
		 * @Author: JustForFun (A-Grade)
		 * @Date: 29.03.2013 23:03
		 * @Correct: JustForFun
		 */
		if(Rnd.chance(15))
		// itemId, count
	...
	{
		/**
		 * @Author: JustForFun (B-Grade)
		 * @Date: 29.03.2013 23:10
		 * @Correct: JustForFun
		 */
		if(Rnd.chance(15))
		// itemId, count
	...
	{
		/**
		 * @Author: JustForFun (C-Grade)
		 * @Date: 30.03.2013 00:30
		 * @Correct: JustForFun P.S. ну все пиздец прплыли,этом не на час XD
		 */
		if(Rnd.chance(15))
		// itemId, count
		{
	...
	{
		/**
		 * @Author: JustForFun (D-Grade)
		 * @Date: 30.03.2013 01:11
		 * @Correct: JustForFun P.S. ну все пиздец прплыли,этом не на час XD
		 */
		if(Rnd.chance(15))
		// itemId, count
	...
	private void use20636(Player player, boolean ctrl)
	{
		int[] list = new int[]{
			...
			20640,
			// Common Item - Light Crossbow
			20641,
			// Common Item - Knight's Sword*Elven
			20642,
			// Common Item - Mithril Gloves
			20643,
			// Common Item - Plate Boots
			20644,
			// Common Item - Plate Shield
			20645,
			// Common Item - Plate Helmet
			20646,
			// Common Item - Plate Gaiters
			20647,
			// Common Item - Half Plate Armor
			20648
			// Common Item - Salamander Skin Mail
		};
		int[] counts = new int[]{
			1,
			1,
	...
	// D-Grade Mage Support Pack by (SmokiMo)
	...
	// ПBeginner's Adventurer Reinforcement Pack by (SmokiMo)
