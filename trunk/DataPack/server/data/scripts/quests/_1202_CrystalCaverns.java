...
import l2next.gameserver.stats.funcs.FuncMul;
...
public class _1202_CrystalCaverns extends Quest implements ScriptFile
{
	...
	private static final int[][] ordreOracle3 = new int[][]{
		{
			OG4,
			OG1,
			OG1,
	...
	private void runSteamRoom1Oracle(World world)
	{
		...
		int[] list = ordreOracle1[Rnd.get(ordreOracle1.length)];
		addSpawnToInstance(list[0], new Location(147090, 152505, -12169, 31613), 0, world.instanceId);
		addSpawnToInstance(list[1], new Location(147090, 152575, -12169, 31613), 0, world.instanceId);
		addSpawnToInstance(list[2], new Location(147090, 152645, -12169, 31613), 0, world.instanceId);
		addSpawnToInstance(list[3], new Location(147090, 152715, -12169, 31613), 0, world.instanceId);
	}
	...
	{
		world.OracleTriggered = false;
		int[] list = ordreOracle2[Rnd.get(ordreOracle2.length)];
		addSpawnToInstance(list[0], new Location(149783, 152505, -12169, 31613), 0, world.instanceId);
		addSpawnToInstance(list[1], new Location(149783, 152575, -12169, 31613), 0, world.instanceId);
		addSpawnToInstance(list[2], new Location(149783, 152645, -12169, 31613), 0, world.instanceId);
		addSpawnToInstance(list[3], new Location(149783, 152715, -12169, 31613), 0, world.instanceId);
	}
	...
	{
		world.OracleTriggered = false;
		int[] list = ordreOracle3[Rnd.get(ordreOracle3.length)];
		addSpawnToInstance(list[0], new Location(152461, 152505, -12169, 31613), 0, world.instanceId);
		addSpawnToInstance(list[1], new Location(152461, 152575, -12169, 31613), 0, world.instanceId);
		addSpawnToInstance(list[2], new Location(152461, 152645, -12169, 31613), 0, world.instanceId);
		addSpawnToInstance(list[3], new Location(152461, 152715, -12169, 31613), 0, world.instanceId);
	}
