...
/**
 * @author cruel
 * @name 495 - Воплощение ревности Феллине
 * @category Daily quest. Party
 * @see http://l2on.net/?c=quests&id=495
 */
public class _495_FelliniTheEmbodimentOfJealousy extends Quest implements ScriptFile
{
	...
	public _495_FelliniTheEmbodimentOfJealousy()
	{
		super(true);
