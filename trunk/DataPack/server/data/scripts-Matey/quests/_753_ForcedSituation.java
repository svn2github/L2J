...
public class _753_ForcedSituation extends Quest implements ScriptFile
{
	...
	public String onKill(NpcInstance npc, QuestState qs)
	{
		...
		if(qs.getQuestItemsCount(KEY) < 30 && Rnd.chance(10))
			...
			if(qs.getQuestItemsCount(KEY) == 100)
				{
	...
	//	if(qs.getQuestItemsCount(KEY) >= 30 && qs.getPlayer().getVar("q753doneKill"))
	//		qs.setCond(2);
	//	if(npc.getNpcId() == 19296 && !qs.getPlayer().getVar("q753doneKill"))
