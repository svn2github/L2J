 ...
 * @name 10343 - Day of Destiny DarkElf Fate
 * @category Class quest. One
 * @see http://l2wiki.com/Day_of_Destiny:_Dark_Elf%27s_Fate
 */
public class _10343_DayOfDestinyDarkElfsFate extends Quest implements ScriptFile
{
	...
	public _10343_DayOfDestinyDarkElfsFate()
	{
		super(false);
		addStartNpc(OLTRAN);
		addTalkId(OLTRAN, QUARTERMASTER, ADEN_VANGUARD_MEMBER, ADOLPH);
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == OLTRAN)
		{
			...
			else if(cond == 0 && race != Race.darkelf)
			{
				htmltext = "30862-02.htm";
			}
			else if(!isAvailableFor(player))
			{
				htmltext = "30862-10.htm";
			}
			else if(cond == 0)
			{
			...
			{
				htmltext = "30862-08.htm";
			}
			else if(cond == 13)
			{
				htmltext = "30862-09.htm";
			}
			else
			{
				htmltext = "30862-08.htm";
