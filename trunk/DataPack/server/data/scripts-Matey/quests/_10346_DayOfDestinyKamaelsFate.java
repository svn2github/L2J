 ...
 * @name 10346 - Day of Destiny Kamaels Fate
 * @category Class quest. One
 * @see http://l2wiki.com/Day_of_Destiny:_Kamael%27s_Fate
 */
public class _10346_DayOfDestinyKamaelsFate extends Quest implements ScriptFile
{
	...
	public _10346_DayOfDestinyKamaelsFate()
	{
		super(false);
		addStartNpc(BROME);
		addTalkId(BROME, QUARTERMASTER, ADEN_VANGUARD_MEMBER, ADOLPH);
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == BROME)
		{
			...
			else if(cond == 0 && race != Race.kamael)
			{
				htmltext = "32221-02.htm";
			}
			else if(!isAvailableFor(player))
			{
				htmltext = "32221-10.htm";
			}
			else if(cond == 0)
			{
			...
			{
				htmltext = "32221-08.htm";
			}
			else if(cond == 13)
			{
				htmltext = "32221-09.htm";
			}
			else
			{
				htmltext = "32221-08.htm";
