 ...
 * @name 10341 - Day of Destiny Elven Fate
 * @category Class quest. One
 * @see http://l2wiki.com/Day_of_Destiny:_Elven_Fate
 */
public class _10342_DayOfDestinyElvenFate extends Quest implements ScriptFile
{
	...
	public _10342_DayOfDestinyElvenFate()
	{
		super(false);
		addStartNpc(WINONIN);
		addTalkId(WINONIN, QUARTERMASTER, ADEN_VANGUARD_MEMBER, ADOLPH);
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == WINONIN)
		{
			...
			else if(cond == 0 && race != Race.elf)
			{
				htmltext = "30856-02.htm";
			}
			else if(!isAvailableFor(player))
			{
				htmltext = "30856-10.htm";
			}
			else if(cond == 0)
			{
			...
			{
				htmltext = "30856-08.htm";
			}
			else if(cond == 13)
			{
				htmltext = "30856-09.htm";
			}
			else
			{
				htmltext = "30856-08.htm";
