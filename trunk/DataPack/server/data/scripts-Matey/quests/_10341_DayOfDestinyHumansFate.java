 ...
 * @name 10341 - Day of Destiny Humans Fate
 * @category Class quest. One
 * @see http://l2wiki.com/Day_of_Destiny:_Human%27s_Fate
 */
public class _10341_DayOfDestinyHumansFate extends Quest implements ScriptFile
{
	...
	public _10341_DayOfDestinyHumansFate()
	{
		super(false);
		addStartNpc(ORVEN);
		addTalkId(ORVEN, QUARTERMASTER, ADEN_VANGUARD_MEMBER, ADOLPH);
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == ORVEN)
		{
			...
			else if(cond == 0 && race != Race.human)
			{
				htmltext = "30857-02.htm";
			}
			else if(!isAvailableFor(player))
			{
				htmltext = "30857-10.htm";
			}
			else if(cond == 0)
			{
