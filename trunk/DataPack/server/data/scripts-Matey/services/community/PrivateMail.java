...
public class PrivateMail extends Functions implements ScriptFile, ICommunityBoardHandler
{
	...
	public void onBypassCommand(Player player, String bypass)
	{
		...
		if("maillist".equals(cmd))
		{
			...
			String html = HtmCache.getInstance().getNotNull("bbs_mail_list.htm", player);
			...
			if(mailList != null)
			{
				...
				String tpl = HtmCache.getInstance().getNotNull("bbs_mailtpl.htm", player);
		...
		else if("mailread".equals(cmd))
		{
			...
			try
			{
				...
				if(rset.next())
				{
					String html = HtmCache.getInstance().getNotNull("bbs_mail_read.htm", player);
