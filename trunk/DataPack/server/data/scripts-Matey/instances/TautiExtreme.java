 ...
 */
public class TautiExtreme extends Reflection
{
	private static final Logger _log = LoggerFactory.getLogger(TautiExtreme.class);
	...
	public class ZoneListener implements OnZoneEnterLeaveListener
	{
		...
		public void onZoneEnter(Zone zone, Creature cha)
		{
			...
			if(checkstartCond(raidplayers.incrementAndGet()))
			{
				...
				_startLaunched = true;
				_log.info("Party in Tauti zone"); // отладочная тестовая информация
