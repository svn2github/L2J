...
public class TreasureBox extends SimpleItemHandler
{
	...
	protected boolean useItemImpl(Player player, ItemInstance item, boolean ctrl)
	{
		...
		switch(itemId)
		{
			...
			case 32241:
				...
				break;
				// -------------Other Items end
			// ------------- Сундук с Сокровищами (Западный ветер)
			case 37607:
				use37607(player, ctrl);
				break;
			// ------------- Сундук с Сокровищами (Западный ветер) end
			
			// ------------- Коробка с Головным Убором (Западный ветер) 
			case 37608:
				use37608(player, ctrl);
				break;
			// -------------Коробка с Головным Убором (Западный ветер)  end
						
			// -------------Коробка с Кулоном (Западный ветер)
			case 37609:
				use37609(player, ctrl);
				break;
			// -------------Коробка с Кулоном (Западный ветер) end
			
			// -------------Коробка со Свитками Модификации (Западный ветер)
			case 37610:
				use37610(player, ctrl);
				break;
			// -------------Коробка со Свитками Модификации (Западный ветер) end

			// -------------Коробка с Рудой Стихий (Западный ветер)
			case 37611:
				use37611(player, ctrl);
				break;
			// -------------Коробка с Рудой Стихий (Западный ветер) end
			
			// -------------Коробка с Материалами (Западный ветер)
			case 37612:
				use37612(player, ctrl);
				break;
			// -------------Коробка с Материалами (Западный ветер) end
			
			//----------Part 2
			
			// ------------- Сундук с Сокровищами Героя (Западный ветер)
			case 37613:
				use37613(player, ctrl);
				break;
			// ------------- Сундук с Сокровищами Героя (Западный ветер) end
			
			// ------------- Сундук Героя: Камень Модификации (Западный ветер)
			case 37614:
				use37614(player, ctrl);
				break;
			// ------------- Сундук Героя: Камень Модификации (Западный ветер) end
						
			// ------------- Сундук Героя: Камень Модификации (Западный ветер)
			case 37615:
				use37615(player, ctrl);
				break;
			// ------------- Сундук Героя: Камень Модификации (Западный ветер) end
			
			// ------------- Сундук Героя: Благ. Свиток Модификации (Западный ветер)
			case 37616:
				use37616(player, ctrl);
				break;
			// ------------- Сундук Героя: Благ. Свиток Модификации (Западный ветер) end

			// ------------- Сундук Героя: Свиток Снятия Оков (Западный ветер)
			case 37617:
				use37617(player, ctrl);
				break;
			// ------------- Сундук Героя: Свиток Снятия Оков (Западный ветер) end
			
			// ------------- Сундук Героя: Кристалл Стихий (Западный ветер)
			case 37618:
				use37618(player, ctrl);
				break;
			// ------------- Сундук Героя: Кристалл Стихий (Западный ветер) end

			// -------------Сундук Возобновления (Западный ветер)
			case 37619:
				use37619(player, ctrl);
				break;
			// -------------Сундук Возобновления (Западный ветер) end
			
			// ------------- Сундук Очищения (Западный ветер)
			case 37620:
				use37620(player, ctrl);
				break;
			// ------------- Сундук Очищения (Западный ветер) end
			
			// ------------- Ящик с Чудесным Зарядом (Западный ветер)
			case 37621:
				use37621(player, ctrl);
				break;
			case 37622:
				use37622(player, ctrl);
				break;
			case 37623:
				use37623(player, ctrl);
				break;
			case 37624:
				use37624(player, ctrl);
			default:
				return false;
		}
	...
	private void use37607(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				37608,
	...
	//   Сундук с Сокровищами Героя (Западный ветер)
	private void use37613(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				37614,
	...
	// --------------------------------------------------Сундук  (Западный ветер) end


	//  Коробка с Головным Убором (Западный ветер)
	private void use37608(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				8921,
	...
	//  Коробка с Кулоном (Западный ветер)
	private void use37609(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				35901,
	...
	// Коробка со Свитками Модификации (Западный ветер)
	private void use37610(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				959,
	...
	// Коробка с Рудой Стихий (Западный ветер)
	private void use37611(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				9546,
	...
	// Коробка с Материалами (Западный ветер) 
	private void use37612(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				36547,
	...
	//   Сундук Героя: Камень Модификации (Западный ветер)
	private void use37614(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				12366,
	...
	//   Сундук Героя Гигантов: Свиток Модификации (Западный ветер)
	private void use37615(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				33810,
	...
	// Сундук Героя: Благ. Свиток Модификации (Западный ветер)
	private void use37616(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				6577,
	...
	//  Сундук Героя: Свиток Снятия Оков (Западный ветер)
	private void use37617(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				36285,
	...
	// Сундук Героя: Кристалл Стихий (Западный ветер)
	private void use37618(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				9552,
	...
	// Сундук Возобновления (Западный ветер)
	private void use37619(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				35741,
	...
	// Сундук Очищения (Западный ветер)
	private void use37620(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				35742,
		...
		// Ящик с Чудесным Зарядом (Западный ветер)
	private void use37621(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				34609,
	...
	// Сундук Энергии Карли (Западный ветер)
	private void use37622(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				36184,
		...
		// Коробка: Бутыль с Душой (Западный ветер)
	private void use37623(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				19465,
		...
		//  Сундук с Камнем Жизни Высшего Качества (Западный ветер)
	private void use37624(Player player, boolean ctrl)
	{
		int[][] list = new int[][]{
			{
				18571,
