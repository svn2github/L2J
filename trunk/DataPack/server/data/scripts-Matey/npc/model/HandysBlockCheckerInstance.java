...
import l2next.gameserver.network.serverpackets.ExCubeGameChangeTimeToStart;
import l2next.gameserver.network.serverpackets.ExCubeGameRequestReady;
import l2next.gameserver.network.serverpackets.ExCubeGameTeamList;
...
public class HandysBlockCheckerInstance extends NpcInstance
{
	 ...
	 *
	 */
	private static final long serialVersionUID = -7357338243703612008L;
