 ...
 * TODO.
 */
public class OrbisTempleStage5 extends DynamicQuest implements ScriptFile
{
	private static final Logger _log = LoggerFactory.getLogger(OrbisTempleStage5.class);
	...
	private static final String START_TIME1 = "20 2 * * *";
	private static final String START_TIME2 = "50 5 * * *";
	private static final String START_TIME3 = "20 9 * * *";
	private static final String START_TIME4 = "50 12 * * *";
	private static final String START_TIME5 = "20 16 * * *";
	private static final String START_TIME6 = "50 19 * * *";
	private static final String START_TIME7 = "20 23 * * *";
	...
	private static final int KILL_OTOH_MOB = 205; // Клиентский параметр
