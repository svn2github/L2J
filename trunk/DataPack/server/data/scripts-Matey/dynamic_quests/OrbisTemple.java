...
public class OrbisTemple extends DynamicQuest implements ScriptFile
{
	...
	private static final String START_TIME1 = "00 00 * * *";
	private static final String START_TIME2 = "30 3 * * *";
	private static final String START_TIME3 = "00 7 * * *";
	private static final String START_TIME4 = "30 10 * * *";
	private static final String START_TIME5 = "00 14 * * *";
	private static final String START_TIME6 = "30 17 * * *";
	private static final String START_TIME7 = "00 21 * * *";
	...
	private static final int KILL_OTOH_MOB = 201; // Клиентский параметр
	...
	private final class KillListenerImpl implements OnKillListener
	{
		...
		public void onKill(Creature actor, Creature victim)
		{
			...
			if(victim.isNpc() && isStarted() && ArrayUtils.contains(LOH_MOBS, victim.getNpcId()))
			{
				...
				{
					case ORBIS1:
						increaseTaskPoint(KILL_OTOH_MOB, actor.getPlayer(), 3); //(unk,Кому, сколько)
						break;
					case ORBIS2:
