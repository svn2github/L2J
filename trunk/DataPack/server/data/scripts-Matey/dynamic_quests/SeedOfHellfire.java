...
import l2next.gameserver.instancemanager.SoHManager;
			...
			if(victim.isNpc() && isStarted())
			{
				switch(victim.getNpcId())
				{
					case SMELTING_FURNACE:
						increaseTaskPoint(KILL_SOH_MOBS, actor.getPlayer(), 1000);
						break;
					case COOLING_DEVICE:
						increaseTaskPoint(KILL_SOH_MOBS, actor.getPlayer(), 2000);
						break;
					case WEAPON_STAND:
						increaseTaskPoint(KILL_SOH_MOBS, actor.getPlayer(), 3000);
						break;
					case ARMOR_STAND:
						increaseTaskPoint(KILL_SOH_MOBS, actor.getPlayer(), 3000);
						break;
					case KOJA_THE_ENGINEER:
						increaseTaskPoint(KILL_SOH_MOBS, actor.getPlayer(), 4000);
						break;
